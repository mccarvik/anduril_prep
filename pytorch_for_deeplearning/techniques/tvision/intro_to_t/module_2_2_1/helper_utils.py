...
def display_grid(grid, save_path=None):
    """
...
def show_images(images, titles, cols=2, save_path=None):
    """
...
def plot_histogram(tensor_image, normalized_tensor, title, save_path=None):
    """
