...
def display_images(
    images=None, grid=None, processed_image=None, titles=None, batch=None, predictions=None, labels=None, class_names=None, figsize=(10, 5), save_path=None
):
    """
...
def upload_jpg_widget():
    ...
    output_image_folder = "./module_2_2_3/images"
